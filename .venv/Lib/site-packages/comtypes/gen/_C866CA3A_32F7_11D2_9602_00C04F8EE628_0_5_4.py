...
__all__ = [
    'SREPhraseStart', 'DISPID_SRRTLength',
    'ISpPhoneticAlphabetSelection', 'SGRSTTDictation',
    'SAFT48kHz8BitMono', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SPAs_NewEnum', 'STSF_CommonAppData', 'SAFT11kHz16BitMono',
    'SpStream', 'ISpeechObjectTokenCategory', 'SVSFIsXML',
    'ISpRecoGrammar2', 'SAFT44kHz16BitMono', 'SPAS_PAUSE',
    'SPCT_SUB_COMMAND', 'SpeechGrammarTagWildcard', 'SVP_13',
    'DISPID_SLPs_NewEnum', 'SPWAVEFORMATTYPE', 'DISPID_SRGCommit',
    'SpeechCategoryAudioIn', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SpeechObjectToken', 'SAFTGSM610_44kHzMono',
    'IEnumSpObjectTokens', 'DISPID_SpeechPhraseProperty', 'SVP_11',
    'SpeechDictationTopicSpelling', 'SVSFlagsAsync',
    'DISPID_SLPsItem', 'SpPhraseInfoBuilder',
    'DISPID_SRRDiscardResultInfo', 'SECFEmulateResult',
    'SVEAudioLevel', 'DISPID_SGRAttributes', 'SPAS_RUN',
    'SAFT24kHz16BitStereo', 'DISPID_SPPName', 'DISPID_SCSBaseStream',
    'DISPID_SWFESamplesPerSec', 'DISPID_SWFEAvgBytesPerSec',
    'DISPIDSPTSI', 'SECFNoSpecialChars', 'DISPID_SpeechGrammarRule',
    'DISPID_SVEventInterests', 'DISPID_SFSClose',
    'DISPID_SpeechMemoryStream', 'SAFTCCITT_uLaw_22kHzMono',
    'ISpeechBaseStream', 'SAFT16kHz8BitStereo',
    'SAFTCCITT_ALaw_44kHzMono', 'SPCATEGORYTYPE',
    'DISPID_SRGDictationSetState', 'SVP_12',
    'DISPID_SPRDisplayAttributes',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SPDKL_LocalMachine',
    'DISPID_SGRAddState', 'DISPID_SAStatus', 'DISPID_SGRSTText',
    'SpeechVisemeType', 'DISPID_SPIRetainedSizeBytes',
    'SVSFParseMask', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SWFEBitsPerSample', 'DISPID_SGRsItem',
    'SPEI_VOICE_CHANGE', 'DISPID_SASCurrentSeekPosition',
    'SAFT16kHz16BitMono', 'DISPID_SRState',
    'SpeechPropertyAdaptationOn', 'DISPID_SGRSAddRuleTransition',
    'SPWT_LEXICAL', 'SPPS_Noun', 'DISPID_SOTSetId',
    'DISPID_SpeechRecognizer', 'SGRSTTWildcard',
    'DISPID_SpeechPhraseElement', 'SAFT16kHz16BitStereo',
    'SpStreamFormatConverter', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SpeechDataKey', 'ISpRecognizer2', 'eLEXTYPE_PRIVATE4',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SpeechFileStream',
    'DISPID_SPPsItem', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SPPNumberOfElements', 'DISPID_SpeechMMSysAudio',
    'SPFM_OPEN_READWRITE', 'SPBO_NONE', 'SPEI_START_SR_STREAM',
    'DISPID_SRCPause', 'DISPID_SRCEBookmark',
    'SPEI_RECO_STATE_CHANGE', 'SpCompressedLexicon', 'SPWORDTYPE',
    'Speech_StreamPos_RealTime', 'SVSFDefault', 'SLODynamic',
    'DISPID_SVEEnginePrivate', 'DISPID_SPIRule', 'SPPHRASEELEMENT',
    'DISPID_SpeechRecoResult2', 'SPGRAMMARSTATE', 'SPEI_RESERVED1',
    'SAFT11kHz16BitStereo', 'SpUnCompressedLexicon',
    'ISpeechPhraseReplacements', 'SRAORetainAudio',
    'DISPID_SRCCreateGrammar', 'DISPID_SGRClear',
    'DISPID_SDKSetBinaryValue', 'DISPID_SVResume',
    'DISPID_SRRecognizer', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SVEStreamEnd', 'DISPID_SGRSRule',
    'IInternetSecurityManager', 'DISPID_SRCESoundStart',
    'SpFileStream', 'SRTReSent', 'eLEXTYPE_PRIVATE18',
    'SAFTExtendedAudioFormat', 'SRERecoOtherContext',
    'SPXMLRESULTOPTIONS', 'DISPID_SPILanguageId',
    'SPFM_OPEN_READONLY', 'DISPID_SpeechAudioBufferInfo',
    'eLEXTYPE_PRIVATE1', 'STCRemoteServer', 'ISpRecognizer',
    'SITooFast', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SWFEBlockAlign', 'DISPID_SLPSymbolic',
    'DISPID_SAFGetWaveFormatEx', 'eLEXTYPE_LETTERTOSOUND', 'SLTApp',
    'SPEI_RECO_OTHER_CONTEXT', 'SpeechCategoryVoices',
    'SAFT24kHz16BitMono', 'SASStop', 'SP_VISEME_0', 'SPLO_STATIC',
    'SpeechPropertyHighConfidenceThreshold', 'SpeechAudioVolume',
    'SP_VISEME_7', 'ISpPhraseAlt', 'ISpRecoContext2',
    'DISPID_SLPLangId', 'DISPID_SpeechLexiconWords', 'SVEViseme',
    'STCLocalServer', 'DISPID_SpeechAudioFormat',
    'eLEXTYPE_PRIVATE19', 'SAFT8kHz16BitStereo',
    'SpeechCategoryAppLexicons', 'SPSLMA', 'SLOStatic',
    'SpeechRuleState', 'SPDKL_DefaultLocation',
    'SpeechEmulationCompareFlags', 'DISPID_SRGSetTextSelection',
    'ISpStream', 'ISpObjectTokenCategory', 'DISPID_SOTRemove',
    'SPSEMANTICFORMAT', 'SREBookmark', 'SPSMF_UPS',
    'DISPID_SRIsShared', 'SpMMAudioOut', 'ISpeechAudioStatus',
    'DISPID_SLWs_NewEnum', 'eLEXTYPE_PRIVATE9', 'SPWORD', 'SPEVENT',
    'ISpeechPhraseRules', 'eWORDTYPE_DELETED', 'SPEI_TTS_BOOKMARK',
    'SREPropertyStringChange', 'SGPronounciation', 'SGDisplay',
    'ISpSerializeState', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'ISpObjectWithToken', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SVEPhoneme', 'SAFTADPCM_8kHzMono',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'ISpeechGrammarRuleStateTransitions', 'SPRST_NUM_STATES',
    'DISPID_SVEStreamStart', 'DISPID_SpeechAudioStatus',
    'SVSFPurgeBeforeSpeak', 'SRSActive', 'DISPID_SPAsCount',
    'SREPropertyNumChange', 'SASPause', 'SPEI_HYPOTHESIS',
    'SpeechLoadOption', 'DISPID_SRGSetWordSequenceData',
    'SREStateChange', 'SP_VISEME_6', 'SpeechMicTraining',
    'DISPID_SVAudioOutput', 'ISpeechObjectToken',
    'SAFT22kHz8BitStereo', 'SREInterference', 'SP_VISEME_21',
    'SPRST_ACTIVE', 'SRCS_Enabled', 'DISPID_SpeechPhraseReplacement',
    'eLEXTYPE_USER', 'SDTProperty', 'Speech_Max_Word_Length',
    ...
    'SPSNotOverriden', 'SPPHRASERULE', 'DISPID_SRGRecoContext',
    'SRSEIsSpeaking', 'eLEXTYPE_RESERVED4', 'SpeechBookmarkOptions',
    'DISPID_SpeechObjectTokens', 'DISPID_SWFEFormatTag',
    'SPAR_Medium', 'SpeechRegistryLocalMachineRoot', 'ISpNotifySink',
    'DISPID_SASCurrentDevicePosition', 'eLEXTYPE_VENDORLEXICON',
    'SpeechAddRemoveWord', 'SPSERIALIZEDRESULT', 'SpNotifyTranslator',
    '_RemotableHandle', 'DISPID_SLWPronunciations', 'DISPID_SOTCId',
    'DISPID_SPRuleParent', 'SP_VISEME_1', 'SRTEmulated',
    'DISPID_SLGetWords', 'DISPID_SLGenerationId', 'SVSFNLPSpeakPunc',
    'DISPID_SLWType', 'SPVOICESTATUS', 'SpeechRecoEvents',
    'ISpeechXMLRecoResult', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SpeechWordPronounceable', 'SPEI_RESERVED3', 'DISPID_SGRSTsCount',
    'DISPID_SRCEEnginePrivate', 'SGLexicalNoSpecialChars',
    'ISpEventSink', 'SREPrivate', 'SINoSignal', 'SVSFPersistXML',
    'DISPID_SRCRetainedAudio', 'DISPID_SOTId', 'DISPID_SPIProperties',
    'DISPID_SGRSTransitions', 'SRSActiveAlways',
    'DISPID_SPEs_NewEnum', 'SSTTTextBuffer', 'DISPID_SpeechVoice',
    'DISPID_SpeechPhraseBuilder', '_ISpeechRecoContextEvents',
    'DISPID_SRCEPhraseStart', 'DISPID_SPRsItem', 'SPEI_SOUND_END',
    'SPRECOCONTEXTSTATUS', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SRGetFormat', '_SPAUDIOSTATE', 'SGDSActive', 'ISpDataKey',
    'SAFTCCITT_uLaw_22kHzStereo', 'SpPhoneConverter',
    'SPEI_INTERFERENCE', 'SPFILEMODE', 'SpAudioFormat',
    'SAFTCCITT_uLaw_11kHzMono', 'ISpRecoResult', 'DISPID_SVDisplayUI',
    'ISpPhrase', 'SFTInput', 'DISPID_SVStatus', 'SVEPhoneme',
    'SGSExclusive', 'ISpeechRecoResultDispatch', 'SPCS_DISABLED',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SDKGetBinaryValue', 'STCAll',
    'DISPID_SLAddPronunciationByPhoneIds', 'SRAONone',
    'SAFT48kHz8BitStereo', 'DISPID_SRGetPropertyString',
    'SPSHT_EMAIL', 'DISPID_SGRSTPropertyValue',
    'DISPID_SVESentenceBoundary', 'STCInprocHandler',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SVAudioOutputStream',
    'DISPID_SRCEventInterests', 'SP_VISEME_8', 'SGLexical',
    'DISPID_SGRAddResource', 'SITooQuiet', 'SSFMOpenForRead',
    'DISPID_SPRuleId', 'SpMMAudioIn',
    'DISPID_SpeechRecoContextEvents', 'eLEXTYPE_PRIVATE10',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'ISpGrammarBuilder',
    'DISPID_SPRuleChildren', 'SVPNormal', 'SPEI_SENTENCE_BOUNDARY',
    'SPTEXTSELECTIONINFO', 'ISpeechPhraseAlternate', 'SRERequestUI',
    'SVEStartInputStream', 'SpMemoryStream',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SPRuleConfidence',
    'SPEI_TTS_PRIVATE', 'DISPID_SpeechPhoneConverter',
    'DISPID_SRCEInterference', 'SpLexicon', 'SP_VISEME_5',
    'ISpeechGrammarRule', 'SRCS_Disabled', 'DISPID_SOTDataKey',
    'SpeechGrammarTagDictation', 'SPVPRI_ALERT',
    'DISPID_SRCERecognizerStateChange', 'ISpeechRecognizerStatus',
    'SPPROPERTYINFO', 'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SPIStartTime', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SPELexicalForm', 'SGSDisabled', 'DISPID_SGRSTType',
    'SPSHT_Unknown', 'SPFM_NUM_MODES', 'DISPID_SRCEAdaptation',
    'DISPID_SRCreateRecoContext', 'SpeechVoiceSpeakFlags',
    'SDKLDefaultLocation', 'eLEXTYPE_RESERVED6', 'SPEI_MAX_TTS',
    'SpeechGrammarWordType', 'SAFTADPCM_22kHzMono',
    'DISPIDSPTSI_SelectionLength', 'SASRun', 'SpeechAudioFormatType',
    'SVEVoiceChange', 'DISPID_SpeechWaveFormatEx',
    'eLEXTYPE_PRIVATE11', 'SVSFParseSapi', 'SPSInterjection',
    'SP_VISEME_11', 'ISpEventSource', 'SAFT44kHz8BitStereo',
    'DISPID_SGRSTsItem', 'SVPAlert', 'SPINTERFERENCE_NONE',
    'DISPID_SWFEChannels', 'SpeechVoiceSkipTypeSentence',
    'SpeechTokenContext', 'SAFT44kHz8BitMono', 'SVSFParseAutodetect',
    'Speech_StreamPos_Asap', 'SVSFIsNotXML', 'SREAudioLevel', 'SVP_6',
    'SPEI_END_INPUT_STREAM', 'DISPID_SpeechAudio',
    'ISpeechPhraseElements', 'SPLEXICONTYPE', 'SPEI_VISEME',
    'DISPID_SRRRecoContext', 'IInternetSecurityMgrSite',
    'SPDATAKEYLOCATION', 'SPSNoun', 'SpeechVoicePriority',
    'SVESentenceBoundary', 'DISPID_SRAudioInput', 'SPEI_MAX_SR',
    'DISPID_SVSInputSentenceLength', 'SDA_One_Trailing_Space',
    ...
    'DISPID_SRRPhraseInfo', 'ISpRecoGrammar', 'SPRST_INACTIVE',
    'DISPID_SRGDictationUnload', 'SP_VISEME_18', 'DISPID_SDKOpenKey',
    'SpSharedRecognizer', 'DISPID_SDKDeleteKey',
    'DISPID_SRRTTickCount', 'DISPID_SVSVisemeId',
    'ISpeechWaveFormatEx', 'DISPID_SDKGetStringValue',
    'DISPID_SABIMinNotification', 'SVP_17', 'DISPID_SVRate',
    'DISPID_SPEsItem', 'DISPID_SRDisplayUI', 'SP_VISEME_17',
    'DISPID_SAVolume', 'SGDSInactive', 'DISPID_SGRSTPropertyId',
    'DISPID_SMSADeviceId', 'SPVPRI_OVER', 'SpShortcut', 'SpVoice',
    'SREFalseRecognition', 'DISPID_SRSetPropertyNumber',
    'DISPID_SPISaveToMemory', 'SPDKL_CurrentConfig', 'ISpMMSysAudio',
    'SpeechVisemeFeature', 'eLEXTYPE_RESERVED9', 'WAVEFORMATEX',
    'ISpRecoContext', 'SPCONTEXTSTATE', 'DISPID_SVSpeak',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SLWsCount', 'SPPHRASEPROPERTY',
    'ISpRecognizer3', 'DISPID_SVGetProfiles', 'ISpProperties',
    'DISPID_SVVoice', 'SpNullPhoneConverter', 'SPSHORTCUTPAIRLIST',
    'SPEI_SOUND_START', 'SVSFVoiceMask', 'eLEXTYPE_PRIVATE15',
    'SpeechGrammarState', 'SpeechGrammarTagUnlimitedDictation',
    'SVP_8', 'SPBO_PAUSE', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SOTCategory', 'tagSPPROPERTYINFO', 'ISpPhoneConverter',
    'SRTExtendableParse', 'SPPS_RESERVED2', 'SPCT_SUB_DICTATION',
    'DISPID_SVSpeakStream', 'DISPID_SpeechPhraseElements',
    'SPSModifier', 'ISpVoice', 'SDA_Consume_Leading_Spaces',
    'SPDKL_CurrentUser', 'ISpObjectToken',
    'DISPID_SRCEPropertyNumberChange', 'SPEI_RESERVED5',
    'eLEXTYPE_MORPHOLOGY', 'IEnumString', 'SpeechInterference',
    'DISPID_SRRGetXMLResult', 'ISpeechRecoResult', 'SP_VISEME_15',
    'DISPID_SRCVoice', 'SPSHT_OTHER', 'SPRECOSTATE',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SRGCmdSetRuleIdState', 'SpeechAudioProperties',
    'ISpStreamFormatConverter', 'SAFT32kHz16BitMono',
    'DISPID_SGRName', 'DISPID_SOTCSetId', 'SpeechStreamFileMode',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SPRulesCount',
    'SPFM_CREATE_ALWAYS', 'DISPID_SOTCEnumerateTokens',
    'STSF_FlagCreate', 'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SPACommit',
    'DISPID_SGRsCommitAndSave', 'SAFT24kHz8BitStereo',
    'SAFTADPCM_22kHzStereo', 'SpPhoneticAlphabetConverter',
    'SpeechCategoryAudioOut', 'SPSSuppressWord',
    'SpeechRetainedAudioOptions', 'DISPID_SPPsCount',
    'DISPID_SRRTStreamTime', 'DISPID_SDKSetStringValue', 'SVF_None',
    'SpeechEngineProperties', 'DISPID_SOTs_NewEnum',
    'DISPID_SPERetainedSizeBytes', 'SRSInactive', 'SPSFunction',
    'DISPID_SRAudioInputStream', 'DISPID_SDKDeleteValue',
    'DISPID_SOTGetDescription', 'SDTAll', 'SPPS_Modifier',
    'SAFT22kHz8BitMono', 'SECLowConfidence', 'SP_VISEME_2',
    'SPINTERFERENCE_NOISE', 'SpeechRecoContextState',
    'ISpeechGrammarRuleStateTransition', 'SpeechCategoryRecognizers',
    'DISPID_SPRs_NewEnum', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SAFType', 'DISPID_SASNonBlockingIO',
    'DISPID_SPEAudioSizeBytes', 'SP_VISEME_14', 'IStream',
    'SpeechPartOfSpeech', 'SVP_9', 'DISPID_SVSInputSentencePosition',
    'ISpeechPhraseInfo', 'DISPID_SpeechCustomStream',
    'SRAInterpreter', 'DISPID_SABIBufferSize', 'DISPID_SVPriority',
    'DISPIDSPRG', 'SAFTGSM610_22kHzMono', 'SRAExport',
    'SpObjectTokenCategory', 'SpeechUserTraining', 'SPEI_PHONEME',
    'ISpeechVoiceStatus', 'DISPID_SBSWrite', 'SGSEnabled',
    'SPEI_RECOGNITION', 'DISPID_SpeechPhraseInfo',
    'DISPID_SDKGetlongValue', 'SREStreamEnd',
    'DISPID_SLPPartOfSpeech', 'SAFT12kHz8BitMono',
    'DISPID_SRSSupportedLanguages', 'DISPID_SVSInputWordLength',
    'SpeechDataKeyLocation', 'DISPID_SPRText', 'SBONone',
    'SVSFUnusedFlags', 'DISPID_SOTsItem', 'ISpeechResourceLoader',
    'DISPID_SAFGuid', 'DISPIDSPTSI_SelectionOffset', 'SP_VISEME_20',
    'SP_VISEME_13', 'SPPS_Function', 'tagSTATSTG',
    'SAFT11kHz8BitStereo', 'SPPHRASE', '_ISpeechVoiceEvents',
    'DISPID_SPAsItem', 'UINT_PTR', 'DISPID_SREmulateRecognition',
    'DISPID_SRGDictationLoad', 'SPAR_Low',
    'SpeechStreamSeekPositionType', 'DISPID_SRSCurrentStreamNumber',
    'SPEI_SR_PRIVATE', 'DISPID_SpeechRecoResult', 'SP_VISEME_12',
    'DISPID_SLPsCount', 'DISPID_SOTMatchesAttributes',
    'DISPID_SASFreeBufferSpace', 'SECFIgnoreWidth', 'SPWORDLIST',
    'SPPARTOFSPEECH', 'ISpeechRecoGrammar', 'SPBO_TIME_UNITS',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SABufferInfo', 'SVP_10',
    'ISpLexicon', 'SPEI_FALSE_RECOGNITION', 'DISPID_SGRSTWeight',
    'SpeechRecognizerState', 'DISPID_SPRFirstElement',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SGRsDynamic',
    'ISpAudio', 'SAFTCCITT_uLaw_8kHzMono', 'ISpeechLexiconWords',
    'SDTAudio', 'DISPID_SVEWord', 'SRESoundStart', 'SRERecognition',
    'SVP_0', 'DISPID_SRCRetainedAudioFormat', 'SDA_No_Trailing_Space',
    'SPRULE', 'SVSFNLPMask', 'SPSEMANTICERRORINFO', 'SP_VISEME_9',
    'DISPID_SRGReset', 'DISPID_SPIEngineId', 'SAFTADPCM_11kHzMono',
    'eLEXTYPE_RESERVED7', 'SpeechPropertyComplexResponseSpeed',
    'SAFTCCITT_uLaw_44kHzStereo', 'eLEXTYPE_PRIVATE5',
    'DISPID_SBSRead', 'SpeechDiscardType', 'ISpeechLexicon',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SLGetPronunciations',
    'DISPID_SGRId', 'eLEXTYPE_PRIVATE16', 'SPSERIALIZEDPHRASE',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SpeechGrammarRuleState', 'SAFT11kHz8BitMono',
    'DISPID_SGRsCommit', 'SPAO_NONE', 'SPSHT_NotOverriden',
    'SGRSTTRule', 'SpeechRuleAttributes', 'DISPID_SLPPhoneIds',
    'DISPID_SRCERequestUI', 'ISpeechRecoContext',
    'DISPID_SVAlertBoundary', 'DISPID_SpeechVoiceEvent', 'SVP_21',
    'SPEI_RESERVED6', 'STSF_LocalAppData', 'SPINTERFERENCE_NOSIGNAL',
    'SpeechTokenIdUserLexicon', 'DISPID_SRRAudio', 'SREHypothesis',
    'SRTStandard', 'ISpeechAudioBufferInfo',
    'ISpeechTextSelectionInformation', 'SPBO_AHEAD',
    'SAFTCCITT_ALaw_44kHzStereo', 'SPEI_TTS_AUDIO_LEVEL',
    'ISpeechObjectTokens', 'DISPID_SPPEngineConfidence',
    'DISPID_SRCResume', 'DISPID_SRGState',
    'DISPID_SpeechGrammarRules', 'DISPID_SPRules_NewEnum',
    'DISPID_SVWaitUntilDone', 'ISpRecoCategory', 'ISpeechVoice',
    'DISPID_SPIReplacements', 'DISPID_SpeechPhraseAlternates',
    'SPADAPTATIONRELEVANCE', 'SGRSTTWord', 'SAFTADPCM_11kHzStereo',
    'eLEXTYPE_PRIVATE12', 'DISPID_SPCIdToPhone',
    'DISPID_SRCEHypothesis', 'SAFTNoAssignedFormat',
    'SAFT8kHz8BitMono', 'DISPID_SGRSAddWordTransition',
    'STSF_AppData', 'DISPID_SOTCGetDataKey',
    'DISPID_SVSInputWordPosition', 'SpObjectToken', 'SPVPRIORITY',
    'SPSTREAMFORMATTYPE', 'ISpeechRecoResultTimes',
    'DISPID_SRSCurrentStreamPosition', 'SAFTCCITT_ALaw_22kHzStereo',
    'SSTTWildcard', 'SPEI_REQUEST_UI', 'SVP_2', 'eLEXTYPE_PRIVATE2',
    'eWORDTYPE_ADDED', 'ISpeechPhraseReplacement',
    'DISPID_SpeechPhraseReplacements',
    'DISPID_SVSCurrentStreamNumber',
    'SpeechPropertyNormalConfidenceThreshold', 'SPCT_DICTATION',
    'SVP_16', 'SPWT_DISPLAY', 'DISPID_SRCCmdMaxAlternates',
    'ISpXMLRecoResult', 'DISPID_SVSLastBookmarkId',
    'DISPID_SGRsCount', 'DISPID_SDKCreateKey',
    'ISpeechPhraseProperties', 'DISPID_SVGetVoices',
    'DISPID_SVSRunningState', 'ISpResourceManager', 'ISpShortcut',
    'DISPID_SLRemovePronunciation', 'SpeechAudioState',
    'DISPID_SGRSTNextState', 'SPINTERFERENCE', 'DISPID_SPRulesItem',
    'SPLOADOPTIONS', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'ISpeechMMSysAudio', 'DISPID_SGRs_NewEnum',
    'ISpeechLexiconPronunciations', 'DISPID_SRGCmdLoadFromObject',
    'SPGS_DISABLED', 'SRADynamic', 'DISPID_SVGetAudioOutputs',
    'SVP_4', 'SpeechFormatType', 'SVEAllEvents',
    'ISpeechLexiconPronunciation', 'SAFTADPCM_8kHzStereo',
    'DISPID_SGRsAdd', 'SPEI_UNDEFINED', 'ISpeechPhraseElement',
    'SREStreamStart', 'DISPID_SPIAudioSizeTime',
    'DISPID_SpeechRecoContext', 'DISPID_SRCEAudioLevel',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SVEBookmark',
    'DISPID_SpeechLexiconWord', 'SWPUnknownWordUnpronounceable',
    'eLEXTYPE_RESERVED10', 'SVP_14', 'eLEXTYPE_PRIVATE8',
    'SAFTCCITT_ALaw_22kHzMono', 'SPVPRI_NORMAL',
    'SpeechPropertyResourceUsage', 'SECNormalConfidence', 'LONG_PTR',
    'DISPID_SPARecoResult', 'DISPID_SRRSetTextFeedback',
    'DISPID_SRCState', 'DISPID_SRSetPropertyString',
    'SpeechVoiceEvents', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SGRSTPropertyName', 'SpeechTokenValueCLSID',
    'SpeechCategoryPhoneConverters', 'SPPS_RESERVED1',
    'SAFT22kHz16BitMono', 'DISPID_SRCEPropertyStringChange',
    'SAFT8kHz8BitStereo', 'DISPID_SPERetainedStreamOffset',
    'SpSharedRecoContext', 'SPRULESTATE', 'SPGS_ENABLED',
    'ISpeechAudioFormat', 'SpeechWordType', 'SpeechAllElements',
    'DISPID_SVGetAudioInputs', 'SPWT_PRONUNCIATION', 'DISPID_SLWWord',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SVF_Stressed',
    'SDTLexicalForm', 'ISpeechDataKey', 'SDTPronunciation',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SRGRules',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SABIEventBias',
    'SDTDisplayText', 'DISPID_SGRInitialState',
    'SAFT22kHz16BitStereo', 'SPEI_END_SR_STREAM',
    'DISPID_SOTCreateInstance', 'eLEXTYPE_PRIVATE6',
    'DISPID_SMSAMMHandle', 'SVEBookmark', 'SPBINARYGRAMMAR',
    'SVSFIsFilename', 'DISPID_SVEVoiceChange', 'SpWaveFormatEx',
    'ISpStreamFormat', 'DISPID_SpeechBaseStream',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPRECORESULTTIMES',
    'SPINTERFERENCE_TOOSLOW', 'SREAdaptation', 'SPCT_COMMAND',
    'SPWORDPRONUNCIATIONLIST', 'SVEWordBoundary',
    'DISPID_SOTCDefault', 'DISPID_SASState', 'SWTAdded',
    'SSFMCreateForWrite', 'DISPID_SLWsItem', 'SPPS_LMA',
    'SAFT32kHz16BitStereo', 'SpTextSelectionInformation',
    'SECFIgnoreKanaType', 'DISPID_SOTsCount', 'DISPID_SMSSetData',
    'DISPID_SRCRecognizer', 'DISPID_SRCSetAdaptationData',
    'SAFT32kHz8BitMono', 'SPINTERFERENCE_LATENCY_WARNING',
    'eLEXTYPE_APP', 'SPAR_High', 'SVEEndInputStream', 'SPEI_MIN_TTS',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SBSFormat',
    'DISPID_SpeechPhraseProperties', 'DISPID_SRCRequestedUIType',
    'DISPID_SLAddPronunciation', 'SRSEDone', 'SP_VISEME_4',
    'SAFT12kHz16BitMono', 'SPAUDIOBUFFERINFO',
    'SGDSActiveWithAutoPause', 'ISpNotifySource',
    'SPRECOGNIZERSTATUS', 'SPEVENTENUM', 'SRTAutopause',
    'DISPID_SPPValue', 'SPGRAMMARWORDTYPE', 'SPEI_SR_BOOKMARK',
    'SRADefaultToActive', 'SPXRO_SML',
    'SpeechPropertyLowConfidenceThreshold', 'SSTTDictation',
    'SINoise', 'DISPID_SAFSetWaveFormatEx', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SVEAudioLevel', 'DISPID_SPPConfidence',
    'DISPID_SRCBookmark', 'SAFT24kHz8BitMono', 'SAFTADPCM_44kHzMono',
    'DISPID_SRGId', 'SpCustomStream', 'SDKLCurrentConfig',
    'SPEI_PHRASE_START', 'SPPS_NotOverriden', 'SPPS_RESERVED4',
    'DISPID_SOTGetAttribute', 'SpeechRecoProfileProperties',
    'ISpNotifyTranslator', 'SpMMAudioEnum', 'DISPID_SRCEStartStream',
    'DISPID_SRSAudioStatus', 'eLEXTYPE_PRIVATE13',
    'SPEI_WORD_BOUNDARY', 'SAFTNonStandardFormat',
    'SAFTGSM610_11kHzMono', 'DISPID_SVVolume', 'SDTReplacement',
    'SAFTText', 'SAFTCCITT_ALaw_8kHzMono', 'DISPIDSPTSI_ActiveLength',
    'ISpeechPhraseRule', 'ISpeechMemoryStream', 'DISPID_SMSGetData',
    ...
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'eLEXTYPE_PRIVATE3',
    'SpeechRecognitionType', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SVEViseme',
    'SpeechSpecialTransitionType', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SBSSeek', 'SpeechDisplayAttributes', 'SpeechRunState',
    'SVP_3', 'SGRSTTTextBuffer', 'DISPID_SRIsUISupported',
    'DISPID_SRRSpeakAudio', 'SpeechTokenKeyUI',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SpeechLexiconProns',
    'SP_VISEME_16', 'SAFTDefault', 'SRATopLevel', 'SPWF_INPUT',
    'SPPS_RESERVED3', 'DISPID_SPEPronunciation', 'DISPID_SVPause',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SVIsUISupported',
    'DISPID_SpeechRecognizerStatus',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SPEI_ADAPTATION',
    'SPPS_Noncontent', 'Speech_Max_Pron_Length', 'SPGS_EXCLUSIVE',
    'DISPID_SPCPhoneToId', 'DISPID_SLGetGenerationChange',
    'SDA_Two_Trailing_Spaces', 'SPEI_RESERVED2',
    'SpeechRegistryUserRoot', 'SpeechLexiconType', 'SVF_Emphasis',
    'SPSHORTCUTTYPE', 'SPPS_Interjection',
    'SpeechAudioFormatGUIDText', 'SPAUDIOSTATE', 'SPEI_MIN_SR',
    'SVSFParseSsml', 'DISPID_SRRSaveToMemory',
    'DISPID_SOTIsUISupported', 'SRARoot', 'DISPID_SpeechLexicon',
    'SGRSTTEpsilon', 'SRSInactiveWithPurge',
    'DISPID_SPEAudioSizeTime',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPAO_RETAIN_AUDIO', 'ISpeechRecognizer', 'SAFT44kHz16BitStereo',
    'ISpeechLexiconWord', 'DISPID_SGRSTRule', 'SAFTADPCM_44kHzStereo',
    'DISPID_SPEDisplayAttributes', 'DISPID_SRProfile',
    'SpResourceManager', 'DISPID_SLWLangId',
    'DISPID_SPRuleNumberOfElements', 'SAFT12kHz8BitStereo',
    'SpeechTokenKeyAttributes', 'SpeechPropertyResponseSpeed',
    'SINone', 'SpeechTokenKeyFiles', 'DISPID_SMSALineId',
    'eLEXTYPE_RESERVED8', 'SPWORDPRONOUNCEABLE',
    'DISPID_SGRsFindRule', 'SVPOver', 'ISpeechPhraseInfoBuilder',
    'SPPS_Verb', 'DISPID_SRRAudioFormat', 'SAFTCCITT_ALaw_8kHzStereo',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SPEsCount',
    'DISPID_SRCEFalseRecognition', 'DISPID_SDKSetLongValue', 'SVP_18',
    'DISPID_SABufferNotifySize', 'DISPID_SPEEngineConfidence',
    'DISPID_SPIElements', 'DISPID_SOTGetStorageFileName',
    'SPWF_SRENGINE', 'DISPID_SPAStartElementInResult',
    'SECHighConfidence', 'SDTAlternates', 'SPSUnknown', 'SPRS_ACTIVE',
    'SSSPTRelativeToEnd', 'DISPID_SPPs_NewEnum',
    ...
    'Speech_Default_Weight', 'SDTRule', 'DISPID_SOTDisplayUI',
    'SFTSREngine', 'SPPS_Unknown',
    'DISPID_SRCERecognitionForOtherContext', 'SITooSlow',
    'DISPID_SRRAlternates', 'SSFMCreate', 'ISpeechCustomStream',
    'SpeechCategoryRecoProfiles', 'SpeechTokenShellFolder',
    'DISPID_SVSLastBookmark', 'DISPID_SRGetRecognizers',
    'DISPID_SPRuleName', 'SECFDefault', 'SPPS_SuppressWord',
    'SPAS_CLOSED', 'SpInprocRecognizer', 'SAFTGSM610_8kHzMono',
    'SRAImport', 'DISPID_SPIAudioSizeBytes', 'SP_VISEME_10',
    'DISPID_SPRNumberOfElements', 'SPSVerb', 'SPEVENTSOURCEINFO',
    'SSSPTRelativeToStart', 'SPFM_CREATE', 'DISPID_SPIGrammarId',
    'DISPID_SDKEnumKeys', 'DISPID_SPERequiredConfidence',
    'DISPID_SPRsCount', 'SPPHRASEREPLACEMENT',
    'DISPID_SRRTOffsetFromStart', 'SDKLCurrentUser', 'SECFIgnoreCase',
    'DISPID_SpeechGrammarRuleStateTransition', 'SAFT32kHz8BitStereo',
    'SPWORDPRONUNCIATION', 'DISPID_SRCESoundEnd',
    'DISPID_SVSPhonemeId', 'SVP_5', 'SPRS_INACTIVE',
    'eLEXTYPE_PRIVATE17', 'ISpeechRecoResult2', 'SPAUDIOSTATUS',
    'ISpeechGrammarRules', 'SLTUser', 'ISequentialStream',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SRGCmdLoadFromFile',
    'ISpeechGrammarRuleState', 'SDKLLocalMachine', 'SPAR_Unknown',
    'DISPID_SPIEnginePrivateData', 'ISpeechPhraseAlternates',
    'SVP_19', 'DISPID_SLPType', 'DISPID_SAEventHandle', 'SPAS_STOP',
    'DISPID_SpeechRecoResultTimes', 'SPEI_SR_RETAINEDAUDIO',
    'ISpeechFileStream', 'SPCS_ENABLED', 'SPBOOKMARKOPTIONS',
    'SPLO_DYNAMIC', 'DISPID_SRStatus', 'DISPID_SRCVoicePurgeEvent',
    'ISpeechPhoneConverter', 'DISPID_SPPChildren',
    'eLEXTYPE_PRIVATE7', 'SBOPause', 'DISPID_SpeechPhraseRule',
    'SSFMOpenReadWrite', 'DISPID_SRGetPropertyNumber',
    'DISPID_SRCEEndStream', 'eLEXTYPE_PRIVATE20', 'SITooLoud',
    'DISPID_SRSClsidEngine', 'SVP_1', 'DISPID_SpeechVoiceStatus',
    'DISPID_SRGCmdLoadFromMemory', 'ISpPhoneticAlphabetConverter',
    'SPXRO_Alternates_SML', 'SREAllEvents', 'DISPID_SGRSTs_NewEnum',
    '__MIDL_IWinTypes_0009', 'DISPID_SVSkip', 'SRESoundEnd',
    'ISpeechAudio', 'DISPID_SPPParent', 'SVEPrivate',
    'DISPID_SDKEnumValues', 'DISPID_SPCLangId', 'SPVISEMES', 'SVP_15',
    'SVP_7', 'STCInprocServer', 'SP_VISEME_3', 'SPCT_SLEEP',
    'SAFT12kHz16BitStereo', 'DISPID_SRGCmdLoadFromResource', 'SVP_20',
    'SAFT48kHz16BitMono', 'SpInProcRecoContext', 'DISPID_SASetState',
    'SP_VISEME_19', 'DISPID_SVSLastStreamNumberQueued',
    'SWPKnownWordPronounceable', 'DISPID_SVSLastResult', 'SWTDeleted',
    'SpeechVoiceCategoryTTSRate', 'SASClosed',
    'ISpeechPhraseProperty', 'SPINTERFERENCE_TOOLOUD',
    'SpeechAudioFormatGUIDWave', 'SAFT16kHz8BitMono',
    'SpeechEngineConfidence', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SPAPhraseInfo', 'SPRS_ACTIVE_USER_DELIMITED',
    'SPSHORTCUTPAIR', 'DISPID_SRRTimes', 'DISPID_SADefaultFormat',
    'SWPUnknownWordPronounceable', 'DISPID_SFSOpen'
]

_check_version('1.1.14', 1700169475.054634)
